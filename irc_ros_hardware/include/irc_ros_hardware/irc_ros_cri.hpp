...
#include "FastPositionInterface/position_interface_socket.hpp"
...
private:
  ...
  FastPositionInterfaceSocket m_fastPositionInterface;

  bool m_posInterfaceRunning;
  bool m_posInterfaceInUse;
  int m_posInterfacePort;
  ...
  void ProcessCmd(const cri_messages::Command &);
  ...
  //Starts the fast position interface
  void ConfigureFastPositionInterface();
  void StartFastPositionInterface();
