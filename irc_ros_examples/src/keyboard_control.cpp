...
public:
  KeyboardCtrl() : Node("KeyboardCtrl")
  {
    ...
    jointPositionPub_ = create_publisher<std_msgs::msg::Float64MultiArray>("joint_position_controller/commands", rclcpp::SystemDefaultsQoS());
...
private:
    ...
    void Enable()
    {
        ...
        command.outputs.push_back(enabled);
...
//*************************************NEGATIVE MOVEMENT COMMANDS***********************************
    ...
    rclcpp::Publisher<std_msgs::msg::Float64MultiArray>::SharedPtr jointPositionPub_;
